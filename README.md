...
Check one web response for common defensive security headers.
...
Open <http://127.0.0.1:8080> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
